...
DATASET_ROOT = Path(__file__).parent / "datasets" / "DATA_SET_FOR_RELEASE" / "renamed"
MODEL_OUTPUT_PATH = Path(__file__).parent / "models" / "corrosion_detector.pth"
...
def train_corrosion_detector():
    ...
    metadata_path = Path(__file__).parent / "models" / "corrosion_detector_metadata.json"
