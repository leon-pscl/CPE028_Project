...
3. **Processed Datasets** - Cleaned and standardized training data in `training/datasets/pre_processed/`
...
├── predict.py                                  # Legacy inference module
...
5. Save processed data to `training/datasets/pre_processed/`
